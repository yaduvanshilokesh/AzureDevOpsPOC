...
Copy-Item -Path "\\localhost\c$\Users\lokesh.yadav\Desktop\Agent\_work\2\s\testwebapp\obj\Release\Package\PackageTmp" -Destination "\\localhost\d$\AzureDevOpsPOC\$websitename" -Recurse -force